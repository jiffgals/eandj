...
<body>
	...
	<div class="row">
		<div class="form-group">
		    <label class="control-label col-sm-4" for="name"><b>Product_Sales</b></label>
		    <div class="col-sm-4">
		        <input type="text" class="form-control" name="search" placeholder="name or price" value="Enervon">
		    </div>
		    <div class="col-sm-2">
		    	...
		    	if(!$product_name)
		    	{
		    	    ...
		    	    foreach($product_name as $key=>$value)
		    	    {
		    	 	...
		    	 	<tr>
		    	 		...
		    	 		<td><a href="database/report_pdf.php?report=purchase_orders" target="_blank"><?php echo $value['product_name'];?></a></td>
