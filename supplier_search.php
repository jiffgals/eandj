...
if(isset($_POST['save']))
{
	if(!empty($_POST['search']))
	{
		...
		$stmt = $con->prepare("select * FROM suppliers
                                        WHERE supplier_name like '%$search%' or supplier_location like '%$search%' 
										    or email like '%$search%' or id like '%$search%'
...
<div class="container">
	...
	<div class="row">
		<div class="form-group">
		    <label class="control-label col-sm-4" for="name"><b>Search_Brand/Supp</b></label>
		    <div class="col-sm-4">
		        <input type="text" class="form-control" name="search" placeholder="brand/supplier, location or email" value="Branded">
		    </div>
		    <div class="col-sm-2">
		    	...
		    	if(!$supplier)
		    	{
		    	    ...
		    	    foreach($supplier as $key=>$value)
		    	    {
		    	 	...
		    	 	<tr>
		    	 		...
		    	 		<td><a href="supplier-view.php" target="_blank"><?php echo $value['supplier_name'];?></a></td>
		    	 		<td><?php echo $value['supplier_location'];?></td>
