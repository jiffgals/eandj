...
// try {
    ...
    foreach($purchase_orders as $po){ // $purchase_orders is a loop which process the order product.
        ...
        if($delivered > 0){
            ...
            // Select statement - to pull the current quqntity of product.
            $stmt = $conn->prepare("
        ...
        // Update statement - to add teh delivered product to the cur quqntity
