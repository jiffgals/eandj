                                            ...
                                            <tbody>
                                                <?php foreach($products as $index => $product){ ?>
                                                    <tr>
                                                        ...
                                                        <td class="email"><b><font color="green"><?= $product['description'] ?></font></b></td>
                                                        <td class="lastName"><?= number_format( $product['stock']) ?></td> <!-- using number_format will addd comma to numbers to specify the number of of stocks available. -->
                                                        <td class="email">
                                                            <?php
                                                                $supplier_list = '.';
                    ...
                    BootstrapDialog.confirm({
                        ...
                        message: '<form action="database/add.php" method="post" enctype="multipart/form-data" id="editProductForm">\
                            ...
                            <div class="appFormInputContainer">\
                                ...
                                <input type="number" class="appFormInput productTextAreaInput" placeholder="Enter product description..." id="description" name="description" /> '+ productDetails.description +' </input>\
                            </div>\
                            <div class="appFormInputContainer">\
                        ...
                        callback: function(isUpdate){
                            if(isUpdate){ // if user click ok button. // <textarea class="appFormInput productTextAreaInput" placeholder="Enter product description..." id="description" name="description"> '+ productDetails.description +'</textarea>\
