...
<DOCTYPE html>
    <html>
    <head>
        <title>Brands / Suppliers Details</title>
                    ...
                    <div class="dashboard_content_main" id="dashboard_content_main">
                        <div class="row">
                            <div class="column column-12">
                                <h1 class="section_header"><i class="fa fa-list"></i> Brands / Suppliers Details</h1>
                                <div class="section_content">
                                    <div class="users">
                                        ...
                                        <p class="userCount"><?= count($suppliers) ?> Brands / Supp </p>
                                    </div>
                                </div>
                            </div>
                        </div>
